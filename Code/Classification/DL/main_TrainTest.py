...
#%% Training 
def train(dataset_conf, train_conf, results_path,X_tr,X_te, y_tr, y_te):
    ...
    for sub in range(n_sub): # (num_sub): for all subjects, (i-1,i): for the ith subject.
        ...
        X_train, y_train_onehot, X_test, y_test_onehot = X_tr, y_tr, X_te, y_te
            
        # X_train, _, y_train_onehot, X_test, _, y_test_onehot = get_data(
        #     data_path, sub, dataset, LOSO = LOSO, isStandard = isStandard) 

        print(X_train.shape, "shape train is") 
